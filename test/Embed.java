...
public final class Embed {
  static URI URI_DEMO = URI.create("http://www.cs.berkeley.edu/~phelps/");
  ...
  */
  public static void local() {
	...
	Browser br = v.getBrowser("browser-instance-name", "System", true);
	...
	br.eventq(Document.MSG_OPEN, URI_DEMO);
